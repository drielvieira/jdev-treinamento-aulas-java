...
public class AlunoPessoaEx02 {
	// CLASSE CRIADA PARA O USO DO MÉTODO toString() DA AULA
	...
	public String toString() {
		return "AlunoPessoaEx02 [nome=" + nome + ", idade=" + idade + ", dataNascimento=" + dataNascimento
